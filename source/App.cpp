...
int main(int argc, const char* argv[]) {
    ...
    // and screen-space reflection to look good at screen edges. Set to zero for
    // maximum performance.
    settings.hdrFramebuffer.colorGuardBandThickness = Vector2int16(64, 64);
    
    // Including the color band. Allows ambient occlusion to look good at screen edges.
